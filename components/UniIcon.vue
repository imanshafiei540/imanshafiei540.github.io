<template>
    <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="university" role="img"
        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-university fa-w-16 fa-3x">
