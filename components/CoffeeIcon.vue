<template>
    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="coffee-togo" role="img"
        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-coffee-togo fa-w-14 fa-3x">
