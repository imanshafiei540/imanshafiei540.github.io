                                    ...
                                    <div class="fw-container">
                                        <div class="row">
                                            ...
                                            <div class=" col-xs-12 col-sm-6 ">
                                                <div id="col_inner_id-5fca86baa733d" class="fw-col-inner"
                                                    ...
                                                    <div id="timeline-5fca86baa7655" class="timeline clearfix">
                                                        ...
                                                        <div class="timeline-item clearfix">
                                                            ...
                                                            <h4 class="item-title">B.Sc. in Computer Software
                                                                Engineering</h4>
                                                            <ul class="ul-disc-style">
                                                                <li>GPA (last 4 semester): 16.43/20 </li>
                                                                <li>Thesis Title: Design and Implementation of an ERP
                                                                    software for managing sales</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="timeline-5fca86baa7655" class="timeline clearfix">
                                                        <div class="timeline-item clearfix">
                                                            <h5 class="item-period ">Oct 2021</h5>
                                                            <span class="item-company">deeplearning.ai</span>
                                                            <h4 class="item-title">Natural Language Processing with
                                                                Classification and Vector Spaces</h4>
                                                            <p>Grade Achieved: 100%</p>
                                                        </div>
                                                        <div class="timeline-item clearfix">
                                                            <h5 class="item-period ">Sep 2021</h5>
                                                            <span class="item-company">Stanford University</span>
                                                            <h4 class="item-title">Machine Learning – Andrew NG </h4>
                                                            <p>Grade Achieved: 96.07%</p>
                                                        </div>
                                                        <div class="timeline-item clearfix">
                                                            <h5 class="item-period ">Jun 2021</h5>
                                                            <span class="item-company">University of Illinois</span>
                                                            <h4 class="item-title">Text Retrieval and Search Engines –
                                                                ChengXiang Zhai</h4>
                                                            <p>Grade Achieved: 86.12%</p>
                                                        </div>
                                                        <div class="timeline-item clearfix">
                                                            <h5 class="item-period ">Jan 2021</h5>
                                                            <span class="item-company">University of Illinois</span>
                                                            <h4 class="item-title">Cloud Computing Concepts – Indranil
                                                                Gupta</h4>
                                                            <p>Grade Achieved: 93.09%</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" col-xs-12 col-sm-6 ">
                                                <div id="col_inner_id-5fca86baa77c4" class="fw-col-inner"
                                                    data-paddings="0px 0px 0px 0px">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" col-xs-12 col-sm-12 ">
                                                <div id="col_inner_id-5fca86baa84e7" class="fw-col-inner"
                                                    data-paddings="0px 0px 0px 0px">
                                            ...
                                            <div class=" col-xs-12 col-sm-6 ">
                                                <div id="col_inner_id-5fca86baa8bca" class="fw-col-inner"
                                                    ...
                                                    <div>
                                                        ...
                                                        <h5 class="skillBadge">Django Rest Framework</h5>
                                                        <h5 class="skillBadge">NuxtJS</h5>
                                                        <h5 class="skillBadge">Flask</h5>
                                                        <h5 class="skillBadge">Django</h5>
                                                        <h5 class="skillBadge">VueJS</h5>
                                                        <h5 class="skillBadge">JavaScript</h5>
                                                        <h5 class="skillBadge">SOA</h5>
